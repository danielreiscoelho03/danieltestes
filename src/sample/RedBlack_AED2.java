...
public class RedBlack_AED2<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        RedBlack_AED2<String, Integer> st = new RedBlack_AED2<String, Integer>();
    ...
    public void printInOrder(RedBlack_AED2.Node node) {
        if (node == null)
            return;
    ...
    //metodo de iteracao que retorna objeto
